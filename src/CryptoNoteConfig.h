...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x65b;
...
const uint64_t MONEY_SUPPLY                                  = 1989091419890900;
...
const char     CRYPTONOTE_NAME[]                             = "galeon";
...
const int      P2P_DEFAULT_PORT                              = 1607;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 1619;
